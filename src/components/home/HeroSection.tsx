        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
          <div>
            ...
            <p className="mt-4 text-lg text-blue-200 max-w-2xl">
              力通电子专注电子元件代理20年，为客户提供正品原装现货，专业技术支持和有竞争力的价格。
            </p>
            ...
            <div className="mt-12 grid grid-cols-2 gap-4 sm:grid-cols-4">
              <div className="text-center">
                ...
                <div className="text-sm text-blue-200">年行业经验</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-white">10万+</div>
                <div className="text-sm text-blue-200">现货型号</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-white">1000+</div>
                <div className="text-sm text-blue-200">服务客户</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-white">99%</div>
                <div className="text-sm text-blue-200">正品保证</div>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="absolute -top-4 -left-4 bg-white rounded-lg p-4 shadow-lg">
                <div className="flex items-center">
                  ...
                  <span className="text-sm font-medium text-gray-900">现货库存</span>
                </div>
              </div>
